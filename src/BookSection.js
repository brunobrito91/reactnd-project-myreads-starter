        ...
        return (
            <div className="list-books">
                ...
                <div className="list-books-content">
                    <div>
                        <BookShelf title="Currently Reading" bookInformations={this.currentlyReading} />
                        <BookShelf title="Want to Read" bookInformations={this.wantToRead} />
                        <BookShelf title="Read" bookInformations={this.read} />
                    </div>
                </div>
